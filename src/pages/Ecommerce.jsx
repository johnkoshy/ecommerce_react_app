...
import { earningData, dropdownData, SparklineAreaData, ecomPieChartData } 
from '../data/dummy';
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="font-bold text-gray-400">Earning</p>
              ...
              {/* <p><span style={{ color: 'green' }}> */}
                {/* <b>&uarr;37.8% </b></span>this month</p> */}
            </div>
          </div>
          ...
          justify-center gap-1 items-center">
            {earningData.map((item) => (
              ...
              >
                ...
                {/* // to work the color of percentage according to 
                // + or -, we need to enter the text-green-600 and then to 
                // text-red-600 and then back to text-${item.pcColor}
                // this is a tailwind bug. */}
          ...
          <div className="flex justify-between">
            ...
            flex-wrap justify-center">
              ...
              <div className="mt-5">
                ...
                color={currentColor}
                // color2 is now passed to sparkline file and
                // then put in mark settings fill value
                // as color2
                // color2="violet"
                />
              </div>
